...
public class SelectTestSuiteScreen extends javax.swing.JFrame {
    ...
    public void populatePane(){
        ...
        File[] savedConfigurationFiles = directory.listFiles();
        for(File file : savedConfigurationFiles){
            String testSuiteName = file.getName().toString();
            testSuiteName = testSuiteName.substring(0, testSuiteName.length()-4);
            System.out.println("File name : " + testSuiteName);
            
            DefaultMutableTreeNode rootNode = (DefaultMutableTreeNode)jTree1.getModel().getRoot();
            DefaultMutableTreeNode testSuiteNode = new DefaultMutableTreeNode(testSuiteName);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTree1.getSelectionCount()==0){
            JOptionPane.showMessageDialog(null, "Select a test suite in order to continue");
            return;
        }
        DefaultMutableTreeNode selectedElement = (DefaultMutableTreeNode)jTree1.getSelectionPath().getLastPathComponent();
        System.out.println("Test Suite selected by user : " + selectedElement.getUserObject().toString()); 
