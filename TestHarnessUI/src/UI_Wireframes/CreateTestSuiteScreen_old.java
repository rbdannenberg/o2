 ...
 * @author Aishu
 */
public class CreateTestSuiteScreen_old extends javax.swing.JFrame {

    /**
     * Creates new form CreateTestSuite2
     */
    public CreateTestSuiteScreen_old() {
        initComponents();
        groupButton();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateTestSuiteScreen_old.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new CreateTestSuiteScreen_old().setVisible(true);
                //f.add(new CreateTestSuiteScreen_old().getContent());
                CreateTestSuiteScreen_old myScreen = new CreateTestSuiteScreen_old();
                myScreen.getContent();
