...
printf("## %d service_info_handler called: %s at %s status %d msg %d "
    ...
    if (streql(service_name, "_cs") || streql(service_name, "_o2")) {
        ...
        if (last_sync == 0) correct = "attr2:value2;";
            ...
            o2assert(streql(properties, "attr1:value1;attr2:value2;") ||
            ...
            o2assert(streql(properties, "attr5:value5;attr4:value4;"
            ...
            o2assert(streql(properties, "attr1:\\\\\\;\\\\\\:\\\\\\\\;"
        ...
        if (last_sync == 0 || last_sync == 1) correct = "attr1:value1;";
            ...
            o2assert(streql(properties, "attr1:value1;") ||
                   streql(properties, "attr2:value2;attr1:value1;") ||
...
int main(int argc, const char * argv[])
{
    ...
    o2assert(o2_service_type(two) == O2_LOCAL);
    ...
    o2assert(streql(o2_service_process(two), "_o2"));
    o2assert(o2_service_tapper(two) == NULL);
    ...
    // set an attr/value
    o2assert(o2_service_set_property("bad", "attr0", "value0") == O2_FAIL);
    o2assert(o2_service_set_property("two", "attr2", "value2") == O2_SUCCESS);
    ...
    o2assert(streql(o2_service_properties(one), "attr1:value1;"));

    // get empty properties from service 2
    printf("two %d props: %s\n", two, o2_service_properties(two));
    o2assert(streql(o2_service_properties(two), "attr2:value2;"));
    ...
    // search for services with attr and value pattern within
    o2assert(o2_service_search(0, "attr1", "val") == one);
    o2assert(o2_service_search(0, "attr2", "val") == two);
    ...
    sync_peers(3);
    lookup();
    o2assert(o2_service_search(0, "attr0", ":value1") == -1);
    o2assert(o2_service_search(0, "attr0", ":onevalue") == one);
    o2assert(o2_service_search(0, "attr0", ":twovalue") == two);
    // search for services with attr and value pattern with ;
    o2assert(o2_service_search(0, "attr0", "value1one;") == one);
    o2assert(o2_service_search(0, "attr0", "value1two;") == two);
    o2assert(o2_service_search(0, "attr0", "value1;") == -1);
    // search for services with attr and exact value
    o2assert(o2_service_search(0, "attr0", ":onevalue1one;") == one);
    o2assert(o2_service_search(0, "attr0", ":twovalue1two;") == two);
    o2assert(o2_service_search(0, "attr0", ":value1two;") == -1);

    sync_peers(4);
    // change value
    o2assert(o2_service_set_property("two", "attr0", "newvalue2") == O2_SUCCESS);
    o2assert(o2_services_list_free() == O2_SUCCESS);
    ...
    o2assert(streql(gp, "newvalue2"));
    O2_FREE((char *) gp);

    sync_peers(6);

    // remove the value
    o2assert(o2_service_property_free("two", "attr0") == O2_SUCCESS);
    o2assert(o2_services_list_free() == O2_SUCCESS);
    ...
    o2assert(streql(gp, "attr1:value1;"));
    gp = o2_service_properties(two);
    o2assert(streql(gp, "attr2:value2;"));

    sync_peers(8);
    // add several new attr/values 2 3 4 5 6
    o2assert(o2_service_set_property("two", "attr1", "value1") == O2_SUCCESS);
    o2assert(o2_service_set_property("two", "attr2", "value2") == O2_SUCCESS);
    o2assert(o2_service_set_property("two", "attr3", "value3") == O2_SUCCESS);
    o2assert(o2_service_set_property("two", "attr4", "value4") == O2_SUCCESS);
    o2assert(o2_service_set_property("two", "attr5", "value5") == O2_SUCCESS);
    ...
    lookup();
    gp = o2_service_properties(one);
    o2assert(streql(gp, "attr5:value5;attr4:value4;attr3:value3;"
                      "attr2:value2;attr1:value1;") ||
    ...
    // remove attrs 1 3 5
    o2assert(o2_services_list_free() == O2_SUCCESS);
    o2assert(o2_service_property_free("two", "attr1") == O2_SUCCESS);
    o2assert(o2_service_property_free("two", "attr3") == O2_SUCCESS);
    o2assert(o2_service_property_free("two", "attr5") == O2_SUCCESS);
    o2assert(o2_services_list_free() == O2_SUCCESS);
    ...
    o2assert(o2_service_getprop(two, "attr1") == NULL);
    o2assert(o2_service_getprop(two, "attr3") == NULL);
    o2assert(o2_service_getprop(two, "attr5") == NULL);
    ...
    sync_peers(12);
    // check escaped chars
    o2assert(o2_service_set_property("two", "attr1", "\\;\\:\\\\") == O2_SUCCESS);
    o2assert(o2_service_set_property("two", "attr2", "\\:value2\\;") ==
           O2_SUCCESS);
    o2assert(o2_service_set_property("two", "attr3", "val\\\\\\\\ue3") ==
           O2_SUCCESS);
    o2assert(o2_service_set_property("two", "attr4", "\\\\\\\\\\;\\:value4") ==
           O2_SUCCESS);
