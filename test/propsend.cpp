...
int main(int argc, const char * argv[])
{
    ...
    sync_peers(4);
    // change value
    o2assert(o2_service_set_property("one", "attr0", "newvalue1") == O2_SUCCESS);
    o2assert(o2_services_list_free() == O2_SUCCESS);
    ...
    // remove the value
    o2assert(o2_service_property_free("one", "attr0") == O2_SUCCESS);
    o2assert(o2_services_list_free() == O2_SUCCESS);
    ...
    lookup();
    gp = o2_service_properties(one);
    o2assert(streql(gp, "attr5:value5;attr4:value4;attr3:"
                      "value3;attr2:value2;attr1:value1;") ||
    ...
    o2assert(o2_service_set_property("one", "attr2", "\\:value2\\;") ==
           O2_SUCCESS);
